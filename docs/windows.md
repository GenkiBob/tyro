...
3. 若仍然提示错误，请先完全退出软件，并卸载电脑中的同类软件或旧版 APP，重启电脑后重新安装
...
1. 若 连接 后无法正常使用，请勾选TUN，并重新 连接 或 勾选 系统代理（TUN：屏幕右下角软件托盘处找到 Digilink 图标，鼠标右键点击图标）。

2. 退出软件或关机前，请先 断开 连接，或打开 开机自启，避免影响下次上网。
:::
